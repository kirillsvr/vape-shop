	...
	<div class="page-content">
		...
		<div class="news-page">
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php if ( !is_paged() ) {?>
					<?php if( $more_posts > 0 ) {?>
						<button class="load-more-content more-item" data-offset="<?php echo $post_per_page;?>" data-perpage="6" data-post-type="post" data-term="<?php echo $term_id;?>">еще  <span><?php echo $next_posts;?> </span></button><span class="ajax-loader"></span>
					<?php } ?>
				<?php } ?>
